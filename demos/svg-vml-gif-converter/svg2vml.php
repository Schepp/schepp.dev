...
function svgToVml($nome)
{
	...
	if (!$cliReq)
	{
		$output  = "<html><head><title>Conversione SVG -> VML: ".$nome_upload."</title>\n";
	...
	if($file)
	{
		...
		if (!$cliReq)
		{
			...
			$svg_name = $ctime.".svg";
			$vml_name = $ctime.".html";
			save_file("",$svg_name,$xml_contents);
			save_file("",$vml_name,$result);
			$output .= "<div id=\"main\">\n";
			$output .= "<h2>Conversione <strong>SVG -&gt; VML</strong>: ".$nome_upload."</h2>\n";
			$output .= "<table width=\"100%\">\n";
			$output .= "<tr><td align=\"center\"><h3>SVG</h3></td>";
			$output .= "<td align=\"center\"><h3>VML</h3></td></tr>\n";
