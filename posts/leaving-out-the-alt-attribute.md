...
It seems I currently look at my Twitter timeline pretty often. This time it was a tweet from Šime Vidas that caught my attention:
...
> Generally authors should avoid using img elements for purposes other than showing images.<br><br>
 If an img element is being used for purposes other than showing an image, e.g. as part of a service to count page views, then the alt attribute must be the empty string.<br><br>
